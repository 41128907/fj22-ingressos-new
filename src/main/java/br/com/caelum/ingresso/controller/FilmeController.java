...
import br.com.caelum.ingresso.imdb.DetalhesDoFIlme;
import br.com.caelum.ingresso.imdb.ImdbClient;
...
public class FilmeController {
    ...
    public ModelAndView detalhes(@PathVariable("id") Integer id){
        ...
        Optional<DetalhesDoFIlme> detalhesDoFIlme = imdbClient.buscaAsInformacoesDoFilme(filme, DetalhesDoFIlme.class);
